...
const skillCategories = [
  ...
  },
  {
    icon: Brain,
    title: "AI & GenAI",
    skills: ["RAG", "Text-to-SQL / NL-to-SQL", "LangChain", "Prompt Engineering", "Pgvector / ChromaDB / Pinecone", "Neo4j Knowledge Graphs"],
  },
  {
    icon: Cloud,
    title: "Cloud & MLOps",
    ...
    <div className="container">
      ...
      >
        ...
        <div className="mt-12 p-6 rounded-xl bg-card border border-border shadow-card">
          <h3 className="font-bold text-foreground mb-4">Certifications & Publications</h3>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
            <div className="flex gap-3 items-start">
              <span className="text-accent font-bold text-lg">📜</span>
              <div>
                <p className="font-medium text-foreground">AWS Certified Cloud Practitioner</p>
                <p className="text-xs text-muted-foreground">Valid through Jul 2026</p>
              </div>
            </div>
            <div className="flex gap-3 items-start">
              <span className="text-accent font-bold text-lg">📄</span>
              <div>
                <p className="font-medium text-foreground">Published in Frontiers in AI</p>
                <p className="text-xs text-muted-foreground">ML-Based Diabetes Prediction (2024)</p>
              </div>
            </div>
            <div className="flex gap-3 items-start">
              <span className="text-accent font-bold text-lg">🏆</span>
              <div>
                <p className="font-medium text-foreground">Community Choice Award</p>
                <p className="text-xs text-muted-foreground">Fall 2025 GenAI Case Competition</p>
              </div>
            </div>
          </div>
        </div>
